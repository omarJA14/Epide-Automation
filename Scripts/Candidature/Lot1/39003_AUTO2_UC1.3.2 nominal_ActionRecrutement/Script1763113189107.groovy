...
for (int i = 1; i <= totalRows; i++) {
	...
	CustomKeywords.'Keywords.commun.UtilsEpide.searchJeuneInRub'(prenomjeune_selec)
	...
	CustomKeywords.'Keywords.commun.UtilsEpide.waitAndClick'(findTestObject('Object Repository/Recrutement/Page_Action_Recrutement/button_AR_EnregistrerFermer'))
	if (!WebUI.waitForElementVisible(findTestObject('Object Repository/Recrutement/Page_Action_Recrutement/Text_AR_EnregistrementModifie'), 10, FailureHandling.OPTIONAL)) {
		KeywordUtil.markFailed("Notification non visible.")
	}
