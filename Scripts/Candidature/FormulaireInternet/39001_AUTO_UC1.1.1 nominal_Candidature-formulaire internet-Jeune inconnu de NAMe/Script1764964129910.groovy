...
for (int i = 1; i <= totalRows; i++) {
	...
	CustomKeywords.'Keywords.commun.UtilsEpide.waitAndClick'(findTestObject('Object Repository/formulaire_internet_creation_candidat/button_Valider'))
	
	CustomKeywords.'Keywords.commun.UtilsEpide.verifySuccessMessage'('Félicitations !', 'Votre candidature a été transmise')
