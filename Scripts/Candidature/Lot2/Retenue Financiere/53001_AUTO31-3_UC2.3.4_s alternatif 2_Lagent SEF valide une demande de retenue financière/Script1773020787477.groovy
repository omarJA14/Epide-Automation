...
CustomKeywords.'Keywords.commun.UtilsEpide.Access_epide'('SEF')
...
for (int i = 1; i <= totalRows; i++) {
	...
	CustomKeywords.'Keywords.commun.UtilsEpide.waitAndVerifyText'(findTestObject('Object Repository/RetenueFinanciere/Page_Simplicit/Elem_Validee'),
		'Validée', 20)
