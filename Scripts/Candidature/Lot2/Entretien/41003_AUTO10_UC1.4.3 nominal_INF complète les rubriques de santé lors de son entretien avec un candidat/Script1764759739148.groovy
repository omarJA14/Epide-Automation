...
//
def radioMapMT = [
	"Oui" : 'Object Repository/INF/Elements_INF/radio_OUI_MedecinTraitant',
	"Non" : 'Object Repository/INF/Elements_INF/radio_NON_MedecinTraitant'
]
CustomKeywords.'Keywords.commun.UtilsEpide.selectFromMap'(medec_trait, radioMapMT)

def radioMapPresCar = [
	"Oui" : 'Object Repository/INF/Elements_INF/radio_OUI_PresentationCarnetVaccinationAttestation',
	"Non" : 'Object Repository/INF/Elements_INF/radio_NON_PresentationCarnetVaccinationAttestation'
]
...
def radioMapAntOrdreFam = [
	"Oui" : 'Object Repository/INF/Elements_INF/radio_OUI_AntecedentsFamiliaux',
	"Non" : 'Object Repository/INF/Elements_INF/radio_NON_AntecedentsFamiliaux'
]
CustomKeywords.'Keywords.commun.UtilsEpide.selectFromMap'(ante_ord_fam, radioMapAntOrdreFam)

def radioMapUrgence = [
	"Oui" : 'Object Repository/INF/Elements_INF/radio_OUI_Avez-vousDejaEtEconduitAuxUrgences',
	"Non" : 'Object Repository/INF/Elements_INF/radio_NON_Avez-vousDejaEtEconduitAuxUrgences'
]
...
def radioMapMoyContr = [
	"Oui" : 'Object Repository/INF/Elements_INF/radio_OUI_Utilisez-vousUnMoyenDeContraception',
	"Non" : 'Object Repository/INF/Elements_INF/radio_NON_Utilisez-vousUnMoyenDeContraception'
]
CustomKeywords.'Keywords.commun.UtilsEpide.selectFromMap'(moyen_contra, radioMapMoyContr)

def radioMapSuiviGynec = [
	"Oui" : 'Object Repository/INF/Elements_INF/radio_OUI_Avez-vousUnSuiviGynecologique',
	"Non" : 'Object Repository/INF/Elements_INF/radio_NON_Avez-vousUnSuiviGynecologique'
]
...
def radioMapPortLune = [
	"Oui" : 'Object Repository/INF/Elements_INF/radio_OUI_PorteLunette',
	"Non" : 'Object Repository/INF/Elements_INF/Radio_NON_PorteLunette'
]
CustomKeywords.'Keywords.commun.UtilsEpide.selectFromMap'(port_lunette, radioMapPortLune)

def radioMapPortLent = [
	"Oui" : 'Object Repository/INF/Elements_INF/radio_OUI_PorteLentilles',
	"Non" : 'Object Repository/INF/Elements_INF/radio_NON_PorteLentilles'
]
...
def radioMapConsDent = [
	"Oui" : 'Object Repository/INF/Elements_INF/radio_OUI_NecessiteUneConsultationDentaire',
	"Non" : 'Object Repository/INF/Elements_INF/radio_NON_NecessiteUneConsultationDentaire'
]
