...
def data_demande_transfert = TestDataFactory.findTestData("demande_transfert")
...
for (int i = 1; i <= totalRows; i++) {
	...
	CustomKeywords.'Keywords.commun.UtilsEpide.waitAndVerifyText'(findTestObject('Object Repository/Demande_Transfert/Check_AvisduCentredorigine'), "Etat Avis du centre d'origine")
	...
	CustomKeywords.'Keywords.commun.UtilsEpide.waitAndVerifyText'(findTestObject('Object Repository/Demande_Transfert/Check_AvisduCentreDestination'), 
		'Etat Avis du centre de destination')
